...
export const TESTIMONIALS = [
  { id: 1, name: 'Jessica Miller', role: 'Frontend Engineer at Google', avatar: 'JM', avatarColor: '#6366F1', text: 'TalentFlow completely changed my job search. Within 2 weeks of creating my profile, I had 5 interviews lined up and landed my dream role at Google!' },
  { id: 2, name: 'Raj Patel', role: 'Engineering Manager at Meta', avatar: 'RP', avatarColor: '#14B8A6', text: 'As a hiring manager, TalentFlow has been invaluable. The quality of candidates we get here is consistently outstanding. Highly recommend.' },
  { id: 3, name: 'Chloe Nguyen', role: 'UX Lead at Airbnb', avatar: 'CN', avatarColor: '#F59E0B', text: 'I was skeptical at first, but TalentFlow delivered. The smart matching algorithm connected me with exactly the kind of roles I was looking for.' },
]
...
export const FAQS = [
  { q: 'How do I post a job on TalentFlow?', a: 'Simply create an employer account, navigate to "Post a Job," fill in the details, and publish. Your job will be live within minutes and visible to thousands of qualified candidates.' },
  { q: 'Is TalentFlow free for job seekers?', a: 'Yes! Creating a candidate profile and applying to jobs is completely free. We offer premium features that give your application more visibility, but the core experience is free.' },
